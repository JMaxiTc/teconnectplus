...
<div class="container mt-4">
    ...
    <form action="{{ url('/catalogos/materias/' . $materia->id_materia . '/actualizar') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="codigo" name="codigo" value="{{ old('codigo', $materia->codigo) }}" required>
        </div>
        <div class="mb-3">
